...
namespace DBF.BridgeMateModel
{
    ...
    public partial class Section
    {
        ...
        public override string               ToString() => $"Id:{Id}, Letter:{Letter}, Tables:{Tables}, MissingPair:{MissingPair}, EwmoveBeforePlay:{EwmoveBeforePlay}, Session:{Session}, ScoringType:{ScoringType}, Winners:{Winners}, OnlineEventGuid:{OnlineEventGuid}, OnlineEventRoundDuration:{OnlineEventRoundDuration}";
    }
}
