...
public class BindableCollectionExtOld<T> : BindableCollection<T>, INotifyPropertyChanged where T : INotifyPropertyChanged
{
    #region Public Constructors
        /// <summary>
        /// Initializes a new instance of the BindableCollectionExtOld class.
        /// </summary>
        public BindableCollectionExtOld()
        {
            CollectionChanged+= collectionChanged;
        }

        /// <summary>
        /// Initializes a new instance of the BindableCollectionExtOld class that contains elements copied from the
        /// specified list.
        /// </summary>
        /// <remarks>
        ...
        public BindableCollectionExtOld(List<T> list) : base((list != null) ? new List<T>(list.Count) : list)
        {
        ...
        public BindableCollectionExtOld(IEnumerable<T> collection)
        {
            if (collection == null)
